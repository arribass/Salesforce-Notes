...
- A Sales email prompt template
  ...
  Correct. Sales email prompt templates are designed to help sales teams draft personalized emails for contacts or leads.
...
Correct Answer: C
Explanation: Service AI Grounding retrieves data from Salesforce objects to ground AI-generated responses. Key considerations:
